...
rag_chain_config = {
    ...
    "input_example": {
        "messages": [{"content": "show me all work orders from Account Name: CSL - AURORA 702", "role": "user"}]
    },
    "llm_config": {
    ...
    "retriever_config": {
        ...
        "parameters": {"k": 20, "query_type": "ann"},
        "schema": {"chunk_text": "content", "document_uri": "work_order_name", "primary_key": "id"},
        "vector_search_index": f"{catalog}.{db}.raw_wo_rika_limit_good_chunk_index",
    },
}
try:
...
with mlflow.start_run(run_name=f"workorder_rag_attempt_3"):
...
MODEL_NAME = "workorder_rag_attempt_4"
MODEL_NAME_FQN = f"{catalog}.{db}.{MODEL_NAME}"

# COMMAND ----------

instructions_to_reviewer = f"""### Instructions for Testing the our Work Order Chatbot assistant
...
user_list = ["erfan.zavareh@terumobct.com"]
# Set the permissions.
